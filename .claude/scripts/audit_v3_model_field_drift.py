...
# first-party
from tests.api.tc.v3.v3_helpers import V3Helper
...
def _candidate_objects() -> list[str]:
    ...
    source = inspect.getsource(V3Helper._module_map)  # noqa: SLF001 — reuse the test's module map
    names: list[str] = []
...
def main(
    ...
    if object_ is not None:
        ...
        if not V3Helper._module_map(object_):  # noqa: SLF001 — reuse the test's module map
